...
unsigned long readFreq(byte* cmd) {
  ...
  return (unsigned long)d7 * 100000000L + (unsigned long)d6 * 10000000L + (unsigned long)d5 * 1000000L + (unsigned long)d4 * 100000L + (unsigned long)d3 * 10000L + (unsigned long)d2 * 1000L + (unsigned long)d1 * 100L + (unsigned long)d0 * 10L;
}
...
*/
    ...
    case 0xf7:
      ...
      */
        response[0] = ((inTx ? 0 : 1) << 7) + ((isHighSWR ? 1 : 0) << 6) +  //hi swr off / on
